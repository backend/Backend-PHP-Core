...
class ControllerTest extends \PHPUnit_Framework_TestCase
{
     ...
     *
     * @expectedException \Backend\Core\Exception
     * @expectedExceptionMessage Trying to set non-existant class in Callback: \SomeClass
     * @return void
     */
     ...
     *
     * @expectedException \Backend\Core\Exception
     * @expectedExceptionMessage Invalid type for function, string expected, got object
     * @return void
     */
     ...
     *
     * @param $callback \Backend\Core\Utilities\Callback The callback to check.
     *
     ...
     *
     * @param $callback \Backend\Core\Utilities\Callback The callback to check.
     * @param $result   string                           The string representation
     * of the callback.
     *
